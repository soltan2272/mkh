    ...
    <div id="">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div style="color: white;padding: 15px 50px 5px 50px;float: left;font-size: 16px;">
                اسم المستخدم &nbsp;
                <a href="login.html" class="btn btn-primary square-btn-adjust">
                    تسجيل الخروج
                </a>
            </div>
        </nav>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>تعديل محتوى الموقع<span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="editWeb_home.html">&nbsp; &nbsp; &nbsp; &nbsp; الصفحة الرئيسية</a>
                            </li>
